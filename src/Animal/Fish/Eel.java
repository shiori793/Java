...
public class Eel extends Fish{
    ...
    public void showInfo(){
        ...
        System.out.println("Gills: " + (this.isHasGills() ? "Has gilles" : "doesn't have gilles"));
        System.out.println("Electric charge: " + (this.isElectric() ? "releases electric charge" : "doesn't release electric charge"));
    }
}
